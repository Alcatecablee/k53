-- K53 Image Features Database Schema
-- This schema supports all 4 phases of the K53 Image Features implementation
...
CREATE TABLE IF NOT EXISTS public.image_scenarios (
    ...
    category TEXT NOT NULL,
    difficulty TEXT NOT NULL CHECK (difficulty IN ('basic', 'intermediate', 'advanced')),
    estimated_time INTEGER NOT NULL DEFAULT 300, -- in seconds
...
CREATE TABLE IF NOT EXISTS public.scenario_decisions (
    ...
    options JSONB NOT NULL, -- Array of {id, text, nextImageId, feedback, correct}
    created_at TIMESTAMP WITH TIME ZONE DEFAULT TIMEZONE('utc'::text, NOW()) NOT NULL
);
...
CREATE TABLE IF NOT EXISTS public.location_learning (
    ...
    location_coordinates JSONB NOT NULL, -- {lat, lng}
...
CREATE TABLE IF NOT EXISTS public.learning_paths (
    ...
    completed_time INTEGER NOT NULL DEFAULT 0, -- in seconds
...
-- (Creating a comprehensive set of policies for all tables)
