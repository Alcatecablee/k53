    ...
    <>
      ...
      <div className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50">
        <a
          ...
          className="bg-white text-slate-900 px-4 py-2 rounded font-medium focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-800"
        >
          Skip to main content
        </a>
        <a
          href="#navigation"
          className="bg-white text-slate-900 px-4 py-2 rounded font-medium focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-slate-800 ml-2"
        >
          Skip to navigation
        </a>
      </div>
