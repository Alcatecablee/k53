...
export const generateRandomTest = (
  ...
  const allControlsQuestions = getQuestionsByCategory("controls");
  const allSignsQuestions = getQuestionsByCategory("signs");
  const allRulesQuestions = getQuestionsByCategory("rules");
  ...
  console.log(`Available questions - Controls: ${allControlsQuestions.length}, Signs: ${allSignsQuestions.length}, Rules: ${allRulesQuestions.length}`);
  console.log(`Requested questions - Controls: ${controlsCount}, Signs: ${signsCount}, Rules: ${rulesCount}`);
  console.log(`Actual questions - Controls: ${actualControlsCount}, Signs: ${actualSignsCount}, Rules: ${actualRulesCount}`);
  ...
  console.log(`Total questions generated: ${combinedQuestions.length}`);
