...
export const k53ScenarioBank: K53Scenario[] = [
  ...
  // NEW CHATGPT SCENARIOS - URBAN SCENARIOS (SC076-SC091)
  {
    ...
    scenario: "You're approaching a major intersection in Sandton during Stage 4 load shedding. The traffic lights (robots) are completely off, and there's moderate traffic coming from all directions.",
    question: "What should you do in this situation?",
    options: ["Proceed with caution as you have right of way", "Treat the intersection as a 4-way stop", "Wait until all traffic clears before proceeding", "Sound your horn and proceed through the intersection"],
    correct: 1,
    explanation: "When traffic lights are not functioning, the intersection must be treated as a 4-way stop. Each vehicle must stop completely and proceed in order of arrival. If vehicles arrive simultaneously, the vehicle on the right has right of way.",
    difficulty: "intermediate",
    context: "urban",
    timeOfDay: "afternoon",
    weather: "clear",
  ...
  },
  {
    ...
    scenario: "You're driving on William Nicol Drive in Johannesburg when a minibus taxi suddenly swerves in front of you from the left lane without indicating, attempting to pick up passengers at an informal taxi stop.",
    question: "What is the appropriate response in this situation?",
    options: ["Accelerate to prevent the taxi from cutting in", "Brake suddenly and sound your horn in anger", "Reduce your speed and allow safe space for the taxi", "Flash your lights and drive aggressively around the taxi"],
    correct: 2,
    explanation: "When a vehicle cuts in front of you unexpectedly, you should reduce your speed to maintain a safe following distance. While the taxi driver's behavior may be improper, defensive driving requires prioritizing safety over right of way. Maintain your composure and adjust your driving to accommodate the situation.",
    difficulty: "intermediate",
    context: "urban",
    timeOfDay: "morning",
    weather: "clear",
  ...
  },
  {
    ...
    scenario: "You're driving through Cape Town CBD on Adderley Street during lunchtime. A pedestrian suddenly steps onto a zebra crossing about 10 meters ahead of you while looking at their phone.",
    question: "What should you do?",
    options: ["Proceed through the crossing as pedestrians must wait for vehicles", "Sound your horn to alert the pedestrian and continue driving", "Slow down gradually and stop completely before the crossing", "Swerve around the pedestrian to avoid stopping"],
    correct: 2,
    explanation: "At a pedestrian crossing, pedestrians have right of way. You must slow down and stop completely to allow pedestrians to cross safely, even if they appear distracted. This is particularly important in busy CBD areas with high pedestrian traffic.",
    difficulty: "basic",
    context: "urban",
    timeOfDay: "afternoon",
    weather: "clear",
  ...
  },
  {
    ...
    scenario: "You need to parallel park your vehicle in a tight space between two cars on Long Street in Cape Town's busy entertainment district. There are pedestrians on the pavement and light traffic on the road.",
    question: "What is the correct procedure for parallel parking in this situation?",
    options: ["Signal right, stop alongside the front vehicle, reverse slowly turning your steering wheel first left then right", "Signal left, drive past the parking space, reverse straight back until you're in position", "Signal left, stop alongside the front vehicle, reverse slowly turning your steering wheel first right then left", "Park elsewhere as parallel parking is too difficult in busy areas"],
    correct: 2,
    explanation: "The correct parallel parking procedure is to signal left, stop alongside the front vehicle with about 1 meter of space between vehicles, reverse slowly while turning your steering wheel first to the right (to bring your rear into the space) and then to the left (to straighten). Always check mirrors and blind spots for pedestrians and other vehicles throughout the maneuver.",
    difficulty: "intermediate",
    context: "urban",
    timeOfDay: "evening",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on Bree Street in central Cape Town when you hear sirens and see an ambulance with flashing lights approaching from behind in heavy traffic. There's limited space to move aside.",
    question: "What should you do?",
    options: ["Continue driving normally as the ambulance will find its way around you", "Stop immediately where you are to let the ambulance pass", "Signal and carefully move to the left where possible, stopping if necessary", "Speed up to clear the road ahead for the ambulance"],
    correct: 2,
    explanation: "When an emergency vehicle approaches with sirens and lights activated, you must give way by moving to the left side of the road where possible and stopping if necessary. If there's limited space in urban areas, make your best effort to create passage, but do so safely without mounting curbs or endangering others.",
    difficulty: "intermediate",
    context: "urban",
    language: "en"
  },
  {
    ...
    scenario: "You're approaching a construction zone on Oxford Road in Rosebank, Johannesburg. There are temporary orange signs, reduced lane markings, and workers visible on site with a temporary speed limit posted.",
    question: "How should you navigate this construction zone?",
    options: ["Maintain your normal speed as the construction doesn't affect your lane", "Reduce speed to the temporary limit, follow lane markings and watch for workers", "Change lanes immediately to avoid the construction area altogether", "Sound your horn to alert workers of your approach"],
    correct: 1,
    explanation: "In construction zones, you must reduce your speed to the temporary posted limit, follow any temporary lane markings carefully, and be especially vigilant for workers who may be close to traffic. Construction zones require extra caution as conditions may change quickly and unexpectedly.",
    difficulty: "basic",
    context: "urban",
    timeOfDay: "morning",
    language: "en"
  },
  {
    ...
    scenario: "You're driving past Claremont High School in Cape Town at 2:30 PM as schools are letting out. There are school zone signs, children crossing the road, and parents' vehicles parked along the roadside.",
    question: "What is the correct way to drive through this school zone?",
    options: ["Drive at the normal speed limit as children should know to stay off the road", "Reduce speed significantly, stay alert for children, and be prepared to stop", "Sound your horn continuously to alert children of your presence", "Accelerate to get through the school zone quickly"],
    correct: 1,
  ...
  },
  {
    ...
    scenario: "You're driving near the Noord Taxi Rank in Johannesburg CBD during rush hour. Minibus taxis are stopping randomly to pick up passengers, pedestrians are crossing between vehicles, and there's general congestion.",
    question: "What is the safest way to navigate through this area?",
    options: ["Drive assertively and don't give way to taxis to establish your position", "Avoid the area completely by taking a longer alternative route", "Reduce speed significantly, maintain larger following distances, and stay alert", "Sound your horn continuously to ensure everyone is aware of your presence"],
    correct: 2,
  ...
  },
  {
    ...
    scenario: "You're approaching the busy traffic circle at Greenpoint in Cape Town with multiple lanes and exits. There's moderate traffic, and some vehicles are already in the circle.",
    question: "What is the correct procedure for entering and exiting this traffic circle?",
    options: ["Yield to all traffic in the circle regardless of which lane they're in, signal when exiting", "Enter without yielding as traffic circles are first-come, first-served", "Yield only to vehicles approaching from your right, no signals needed", "Come to a complete stop before entering regardless of traffic"],
    correct: 0,
    explanation: "When approaching a traffic circle in South Africa, you must yield to all traffic already in the circle regardless of which lane they're in. Use your indicator to signal when you're exiting the circle, not when entering. For multi-lane circles, generally use the left lane for exiting at the first or second exit, and the right lane for later exits, but follow road markings if present.",
    difficulty: "intermediate",
    context: "urban",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the M3 dual carriageway in Cape Town and need to overtake a slower vehicle ahead of you. There are two lanes in your direction and moderate traffic.",
    question: "What is the correct procedure for overtaking on this road?",
    options: ["Overtake on the left (inner) lane if the right lane is occupied", "Always use the right (outer) lane for overtaking, return to the left lane when safe", "Flash your lights to signal the vehicle ahead to move over, then overtake", "Overtake using whichever lane is convenient at the moment"],
    correct: 1,
    explanation: "On dual carriageways in South Africa, the correct procedure for overtaking is to use the right (outer) lane, passing the slower vehicle on their right side, and then return to the left lane once you've safely passed and can see the overtaken vehicle in your rearview mirror. The left lane is the normal driving lane, while the right lane should primarily be used for overtaking.",
    difficulty: "basic",
    context: "urban",
    language: "en"
  },
  {
    ...
    scenario: "While driving on Rivonia Road in Sandton, you notice a cash-in-transit vehicle stopped ahead with security guards in tactical positions. Blue lights are flashing and there's a visible cash transfer happening.",
    question: "What is the safest action to take?",
    options: ["Stop and wait directly behind the cash-in-transit vehicle", "Pull over at a safe distance and wait until the operation is complete", "Drive around the vehicle quickly to avoid any potential danger", "Sound your horn to alert them you need to pass"],
    correct: 1,
    explanation: "Cash-in-transit operations in South Africa can be targets for armed robberies. The safest action is to maintain a significant distance from the operation. Pull over safely if possible and wait until the transfer is complete and the vehicle has moved on. Never pressure the security team by driving too close, sounding your horn, or making sudden movements near their operation.",
    difficulty: "advanced",
    context: "urban",
    timeOfDay: "afternoon",
    language: "en"
  },
  {
    ...
    scenario: "You're approaching the entrance of a security estate in Fourways, Johannesburg. There's a boom gate, security guard, and several vehicles queuing to enter. You're visiting a friend and don't have resident access.",
    question: "What is the correct procedure at this security entrance?",
    options: ["Follow closely behind the car in front to enter on their access", "Stop completely at the boom, provide identification and details of who you're visiting", "Sound your horn to get the guard's attention for faster service", "Drive around the boom if the queue is moving too slowly"],
    correct: 1,
    explanation: "At South African security estate entrances, all visitors must stop completely at the boom gate, provide personal identification (usually driver's license), and provide details of the resident you're visiting. The guard will typically call to confirm your visit is expected. Never tailgate another vehicle through the boom as this is both dangerous and a security violation.",
    difficulty: "basic",
    context: "residential",
    language: "en"
  },
  {
    ...
    scenario: "You're driving toward the V&A Waterfront in Cape Town when you encounter temporary barriers and a 'Road Closed' sign due to a weekend market event. There are traffic officers redirecting vehicles.",
    question: "What should you do in this situation?",
    options: ["Ignore the barriers as you're certain your destination is just beyond them", "Follow the traffic officer's directions even if it means taking a detour", "Stop and argue with the traffic officer about needing access", "Drive around the barriers when the officer isn't looking"],
    correct: 1,
    explanation: "When encountering temporary road closures with traffic officers present, you must always follow their directions, even if it means taking a detour to your destination. Traffic officers' hand signals and instructions supersede regular road signs and rules. Attempting to ignore or circumvent road closures is illegal and dangerous.",
    difficulty: "basic",
    context: "urban",
    timeOfDay: "morning",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on Jan Smuts Avenue in Johannesburg when you notice a Metro Police roadblock ahead checking for licenses and vehicle roadworthiness. There are several police vehicles with flashing lights and officers directing traffic.",
    question: "What is the correct way to approach and handle this roadblock?",
    options: ["Make a U-turn before reaching the roadblock to avoid delays", "Slow down, follow officers' directions, and have your license ready", "Quickly change lanes repeatedly to try to get through faster", "Tell the officers you're in a hurry and ask to be let through quickly"],
    correct: 1,
    explanation: "When approaching a police roadblock in South Africa, you must slow down safely, follow all directions from the officers, and be prepared to present your driver's license and vehicle registration. Remain courteous and cooperative. Making a U-turn to avoid a roadblock is illegal and can result in serious consequences including arrest.",
    difficulty: "intermediate",
    context: "urban",
    timeOfDay: "afternoon",
    language: "en"
  },
  {
    ...
    scenario: "You're on the on-ramp to join the M1 highway in Johannesburg during moderate traffic. The acceleration lane is short, and there are vehicles already traveling at speed on the highway.",
    question: "What is the correct procedure for merging onto the highway in this situation?",
    options: ["Stop at the end of the on-ramp and wait for a large gap in traffic", "Accelerate to match highway speed, use indicators, and merge when safe", "Drive slowly on the on-ramp and expect highway traffic to make way for you", "Accelerate quickly and force your way into the highway traffic"],
    correct: 1,
    explanation: "The correct procedure for merging onto a highway is to use the acceleration lane to match your speed with the flow of traffic, activate your indicator to signal your intention to merge, check mirrors and blind spots, and merge smoothly when a safe gap appears. Vehicles already on the highway have right of way, but defensive driving means both parties should adjust to facilitate safe merging.",
    difficulty: "intermediate",
    context: "urban",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on a residential street in Parkview, Johannesburg at night when you suddenly notice an open manhole in your lane where thieves have removed the cover to steal cables. You're about 15 meters away.",
    question: "What is the correct action to take?",
    options: ["Swerve sharply to avoid the manhole without checking surrounding traffic", "Brake suddenly and come to a complete stop before the hazard", "Check mirrors, reduce speed appropriately and safely navigate around the hazard", "Sound your horn continuously while driving through the hazard"],
    correct: 2,
    explanation: "When encountering a sudden road hazard like an open manhole, you should first check your mirrors to be aware of surrounding traffic, reduce your speed appropriately without braking suddenly (which could cause a rear-end collision), and then safely navigate around the hazard if possible. After passing safely, you should report the hazard to authorities.",
    difficulty: "advanced",
    context: "urban",
    timeOfDay: "night",
    language: "en"
  ...
  // RURAL SCENARIOS (SC092-SC106)
  {
    ...
    scenario: "You're driving on the N2 highway near Port St. Johns in the Eastern Cape when you notice a sign warning of animal crossings. It's dusk, and visibility is becoming limited in this rural area.",
    question: "What precautions should you take in this situation?",
    options: ["Maintain your speed but flash your lights occasionally to scare animals away", "Reduce your speed significantly and increase your following distance", "Sound your horn continuously to warn animals of your approach", "Switch lanes frequently to avoid animals that might appear"],
    correct: 1,
  ...
  },
  {
    ...
    scenario: "Your vehicle experiences a mechanical problem and you need to stop on the N1 highway between Bloemfontein and Colesberg. There's a narrow shoulder, it's daytime, and there's moderate traffic.",
    question: "What is the correct procedure for safely stopping on the highway?",
    options: ["Stop immediately where you are and put on your hazard lights", "Signal, slow down gradually, and pull as far onto the shoulder as safely possible", "Drive at very slow speed until you reach the next town", "Make a U-turn and drive against traffic to the nearest exit"],
    correct: 1,
    explanation: "When experiencing a breakdown on a highway, signal your intention to pull over, slow down gradually, and pull as far onto the shoulder as safely possible. Once stopped, activate your hazard warning lights, place your warning triangle 45 meters behind your vehicle, and ensure all passengers exit the vehicle on the side away from traffic and move to safety behind the barrier if present. Call for assistance and remain visible but at a safe distance from the roadway.",
    difficulty: "intermediate",
    context: "rural",
    timeOfDay: "afternoon",
    language: "en"
  },
  {
    ...
    scenario: "You're driving a vehicle with a trailer descending Van Reenen's Pass on the N3 between Gauteng and KwaZulu-Natal. The road is steep with warning signs about using lower gears.",
    question: "What is the safest way to descend this mountain pass?",
    options: ["Use the brakes continuously to control your speed", "Shift to a lower gear before the descent and use engine braking", "Put the vehicle in neutral to save fuel on the downhill", "Maintain highway speed to avoid causing traffic delays"],
    correct: 1,
    explanation: "When descending steep mountain passes like Van Reenen's Pass, you should shift to a lower gear before beginning the descent and use engine braking to control your speed. This prevents brake overheating and potential brake failure. Using the brakes intermittently (not continuously) helps maintain control. This is especially important when towing a trailer, as the additional weight increases stopping distance and momentum.",
    difficulty: "advanced",
    context: "rural",
    timeOfDay: "morning",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the N7 highway toward Springbok in the Northern Cape when you encounter roadworks with a reduced temporary speed limit of 60 km/h. The normal speed limit is 120 km/h and the road appears clear.",
    question: "What should you do regarding the speed limit?",
    options: ["Maintain 120 km/h as the road appears clear of workers", "Reduce to 80 km/h as a reasonable compromise", "Reduce to 60 km/h and maintain this speed through the entire roadworks section", "Speed up after passing the first roadworks sign if no workers are visible"],
    correct: 2,
    explanation: "Temporary speed limits at roadworks must be obeyed throughout the entire demarcated roadworks section, regardless of whether workers or machinery are visible at that moment. The reduced limits are set for safety due to potential hazards like lane shifts, uneven surfaces, loose gravel, or machinery that may not be immediately visible. Violating roadworks speed limits carries higher penalties and is especially dangerous for road workers.",
    difficulty: "basic",
    context: "rural",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on a rural road near Ceres in the Western Cape and approach a four-way intersection with stop signs in all directions. You arrive at exactly the same time as another vehicle on your right.",
    question: "Who has the right of way in this situation?",
    options: ["You have right of way as you're ready to proceed first", "The vehicle on your right has right of way", "The vehicle with the larger engine capacity has right of way", "Both vehicles should proceed at the same time cautiously"],
    correct: 1,
    explanation: "At a four-way stop intersection where vehicles arrive simultaneously, the vehicle on the right has right of way. This is in accordance with the South African K53 rules and the National Road Traffic Act. Each vehicle must come to a complete stop, and then proceed in order of arrival. When arrivals are simultaneous, yield to the vehicle on your right.",
    difficulty: "basic",
    context: "rural",
    language: "en"
  },
  {
    ...
    scenario: "You're approaching the Bronkhorstspruit toll plaza on the N4 Platinum Highway. There are multiple lanes including e-tag lanes, cash lanes, and credit card lanes with varying queue lengths.",
    question: "Which lane should you choose if you don't have an e-tag but have both cash and credit card?",
    options: ["Any e-tag lane as all lanes can process all payment types", "The lane specifically marked for cash or credit card payments only", "The lane with the shortest queue regardless of payment type markings", "Any lane, as you can argue with the attendant if you choose incorrectly"],
    correct: 1,
    explanation: "At South African toll plazas, you must select a lane that matches your payment method. If you don't have an e-tag, you must use lanes specifically marked for cash or credit card payments. Using an e-tag lane without an e-tag disrupts traffic flow and may result in a violation. Choose the appropriate lane even if other lanes have shorter queues.",
    difficulty: "basic",
    context: "rural",
    timeOfDay: "afternoon",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R63 near Graaff-Reinet in the Eastern Cape when you encounter a slow-moving farm tractor pulling an implement that takes up part of your lane. The road has solid white lines and limited visibility due to curves.",
    question: "What is the correct way to handle this situation?",
    options: ["Overtake immediately to avoid getting stuck behind the tractor", "Follow at a safe distance until there's a legal and safe opportunity to pass", "Sound your horn continuously until the tractor moves off the road", "Cross the solid white line slowly to pass the tractor"],
    correct: 1,
    explanation: "When encountering slow-moving farm vehicles on rural roads, you should maintain a safe following distance until there's a legal and safe opportunity to pass. Even if the vehicle is moving very slowly, you must never overtake on a solid white line or when visibility is limited. Patient, defensive driving is essential on rural roads where agricultural vehicles are common.",
    difficulty: "intermediate",
    context: "rural",
    timeOfDay: "morning",
    language: "en"
  },
  {
    ...
    scenario: "While driving on the R62 in the Klein Karoo between Oudtshoorn and Calitzdorp, you see a hitchhiker on the side of the road signaling for a ride. You're driving alone with empty seats in your vehicle.",
    question: "What is the safest response to this situation?",
    options: ["Stop and offer the hitchhiker a ride as it's common courtesy in rural areas", "Slow down to speak with the hitchhiker before deciding whether to give a ride", "Continue driving without stopping, maintaining your speed and focus on the road", "Stop and give money to the hitchhiker instead of a ride"],
    correct: 2,
    explanation: "For safety reasons, it's advisable not to stop for hitchhikers in South Africa, regardless of location. Continue driving without changing your speed or behavior. Stopping for unknown persons poses significant personal safety risks. If you want to help those needing transportation in rural areas, it's safer to support formal community transport initiatives rather than picking up strangers.",
    difficulty: "basic",
    context: "rural",
    timeOfDay: "afternoon",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R71 between Polokwane and Tzaneen behind a heavily loaded truck that's moving slowly uphill. There's a broken white line in the center of the road, but limited visibility ahead due to the hill crest.",
    question: "What is the correct decision regarding overtaking?",
    options: ["Overtake quickly before reaching the hill crest", "Remain behind the truck until after the hill crest when visibility improves", "Sound your horn to alert oncoming traffic and then overtake", "Follow closely behind the truck to look for gaps in oncoming traffic"],
    correct: 1,
    explanation: "When visibility is limited due to a hill crest, it's unsafe and illegal to overtake even if there's a broken white line. You must remain behind the slower vehicle until you've passed the hill crest and can see that the road ahead is clear enough to overtake safely. Patience is essential for safe driving on rural roads with changing topography.",
    difficulty: "intermediate",
    context: "rural",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the N12 near Kimberley in the Northern Cape when you see a warning sign showing a kudu silhouette. It's late afternoon and the sun is starting to set.",
    question: "What precautions should you take after seeing this sign?",
    options: ["No special precautions are needed unless animals are actually visible", "Reduce speed and increase vigilance, especially near dense vegetation", "Sound your horn periodically to scare away any animals", "Switch on your high beam headlights continuously"],
    correct: 1,
    explanation: "Animal warning signs, particularly for large antelope like kudu, indicate high-risk areas for animal crossings. You should reduce your speed and increase vigilance, scanning both the road and roadside vegetation where animals may be hidden. This is especially important during dawn, dusk, and night when many animals are most active. A collision with a large antelope can be fatal for both the animal and vehicle occupants.",
    difficulty: "basic",
    context: "rural",
    timeOfDay: "evening",
    language: "en"
  },
  {
    ...
    scenario: "While driving on the N10 between Cradock and Cookhouse in the Eastern Cape, you come upon a recent accident scene. There's a damaged vehicle on the side of the road, people standing nearby, but no emergency services present yet.",
    question: "What is the correct response to this situation?",
    options: ["Drive past without stopping to avoid creating more congestion", "Stop immediately in the road and get out to help", "Slow down, stop safely if you can assist, or proceed cautiously if others are helping", "Take photos of the accident to report to authorities later"],
    correct: 2,
    explanation: "When encountering an accident scene where emergency services haven't yet arrived, first slow down and assess the situation safely. If stopping to assist, pull completely off the road with hazard lights on. Check if anyone needs urgent medical help, call emergency services (10111 or 112), and provide basic first aid if you're trained. If others are already assisting, proceed cautiously without creating additional hazards. Never stop in a dangerous position that could cause another accident.",
    difficulty: "advanced",
    context: "rural",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R75 between Uitenhage and Graaff-Reinet, approximately 60km from the nearest town, when your fuel gauge warning light illuminates. There are no visible fuel stations on this stretch of rural road.",
    question: "What is the best course of action?",
    options: ["Continue at normal speed to reach the next town quickly", "Pull over immediately and call for assistance", "Reduce speed, turn off air conditioning, and drive economically to the nearest fuel station", "Stop and flag down another vehicle to ask for fuel"],
    correct: 2,
    explanation: "When the fuel warning light illuminates in a rural area, you should take immediate steps to conserve fuel while proceeding to the nearest fuel station. Reduce your speed (fuel consumption increases significantly at higher speeds), turn off the air conditioning, and drive in the highest gear possible at your reduced speed. Most vehicles can travel 30-50km after the warning light appears, but this varies by vehicle. If possible, use a map or GPS to locate the nearest fuel station rather than just heading to the next town.",
    difficulty: "intermediate",
    context: "rural",
    timeOfDay: "afternoon",
    language: "en"
  },
  {
    ...
    scenario: "You're approaching a narrow single-lane bridge on the R356 near Sutherland in the Northern Cape. There's a yield sign on your side, and a vehicle is approaching from the opposite direction.",
    question: "What should you do in this situation?",
    options: ["Accelerate to cross the bridge before the other vehicle arrives", "Proceed onto the bridge and expect the other vehicle to reverse if you meet", "Stop before the bridge, yield to the oncoming vehicle, and then proceed", "Sound your horn to assert your right of way"],
    correct: 2,
    explanation: "When approaching a single-lane bridge with a yield sign on your side, you must stop before the bridge and give way to any vehicles already on the bridge or about to enter from the opposite side (which doesn't have a yield sign). Only proceed when the bridge is completely clear. Single-lane bridges are common on rural South African roads and require courtesy and patience.",
    difficulty: "basic",
    context: "rural",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R61 near Mthatha in the Eastern Cape when you encounter a herd of cattle crossing the road, supervised by a young herdsman. There's no formal animal crossing warning.",
    question: "What is the appropriate action to take?",
    options: ["Sound your horn continuously to scatter the cattle and clear your path", "Maintain your speed but swerve between the animals", "Stop completely and wait patiently for all animals to cross", "Drive slowly through the herd forcing them to move aside"],
    correct: 2,
    explanation: "When encountering livestock crossing a rural road, you must stop completely and wait patiently for all animals to cross. Sounding your horn may startle the animals causing unpredictable movements and possible accidents. Livestock herding is common in many rural South African areas, and respecting this practice is both a safety measure and a courtesy to rural communities. After the incident, continue to drive cautiously as stray animals may still be near the road.",
    difficulty: "intermediate",
    context: "rural",
    timeOfDay: "morning",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the N11 between Newcastle and Volksrust and pass a sign reducing the speed limit from 120 km/h to 80 km/h as you approach a small rural settlement.",
    question: "When should you begin reducing your speed after seeing this sign?",
    options: ["Gradually reduce speed after passing the sign to reach 80 km/h at the next sign", "Begin reducing speed before reaching the sign", "Immediately reduce to exactly 80 km/h precisely at the sign", "Reduce speed only when you see the actual settlement"],
    correct: 2,
    explanation: "Speed limit signs indicate the maximum legal speed from the point where the sign is positioned. You must have reduced your speed to 80 km/h or below by the time you reach the sign, not after it. This is particularly important when entering rural settlements where pedestrians, animals, and local traffic may be present. Ignoring reduced speed limits in rural settlements is a common cause of serious accidents.",
    difficulty: "basic",
    context: "rural",
    language: "en"
  },
  // WEATHER-RELATED SCENARIOS (SC107-SC126)
  {
    ...
    scenario: "You're driving on the N1 near Century City in Cape Town during heavy winter rainfall. The road is wet, visibility is reduced, and there's moderate traffic around you.",
    question: "How should you adjust your driving in these rainy conditions?",
    options: ["Maintain normal speed but turn on headlights", "Reduce speed by at least 20%, increase following distance, and use headlights", "Pull over and wait for the rain to stop completely", "Drive in the emergency lane where there's less water"],
    correct: 1,
  ...
  },
  {
    ...
    scenario: "You're driving on the N2 near George during heavy coastal rain when you suddenly feel your vehicle lose contact with the road and begin to slide on surface water (aquaplaning).",
    question: "What is the correct way to handle aquaplaning?",
    options: ["Brake firmly and steer in the opposite direction of the slide", "Accelerate to push through the water more effectively", "Ease off the accelerator, keep steering straight, and don't brake suddenly", "Turn on your hazard lights and brake hard"],
    correct: 2,
    explanation: "When aquaplaning occurs, you should ease off the accelerator (don't brake), keep steering straight (or make only very gentle steering adjustments if necessary), and hold a firm grip on the steering wheel. Sudden braking or steering can cause complete loss of control. Once you feel traction return, gently apply brakes to reduce speed further. To prevent aquaplaning, reduce speed on wet roads, maintain proper tire pressure and tread depth, and avoid standing water when possible.",
    difficulty: "advanced",
    context: "rural",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on Tafelberg Road near Table Mountain in Cape Town when you suddenly enter a dense bank of fog. Visibility drops to less than 20 meters ahead.",
    question: "What actions should you take when suddenly entering fog?",
    options: ["Turn on high beam headlights to penetrate the fog better", "Pull over immediately wherever you are and wait for the fog to clear", "Reduce speed significantly, turn on low beam headlights and fog lights if equipped", "Follow the taillights of the vehicle ahead closely to navigate"],
    correct: 2,
    explanation: "When suddenly entering fog, you should reduce your speed significantly, turn on low beam headlights (high beams reflect off fog and reduce visibility further), and fog lights if equipped. Increase following distance as stopping distances remain the same but reaction time is affected by reduced visibility. Use the road's edge line as a guide rather than the center line where possible. Only pull over if you can get completely off the road in a safe location, with hazard lights on.",
    difficulty: "advanced",
    context: "urban",
    weather: "fog",
    language: "en"
  },
  {
    ...
    scenario: "You're driving in Sandton, Johannesburg during a severe summer thunderstorm with lightning, heavy rain, and some hail. Traffic signals at the upcoming intersection aren't functioning due to a power outage.",
    question: "How should you proceed through the intersection with non-functioning traffic signals?",
    options: ["Proceed with caution if no other vehicles are visible", "Treat it as a yield intersection with main road having priority", "Stop completely and then proceed only when safe, treating it as a 4-way stop", "Sound your horn and proceed through the intersection"],
    correct: 2,
    explanation: "When traffic signals are not functioning due to power outages (common during Johannesburg thunderstorms), you must treat the intersection as a 4-way stop regardless of the size of the roads. Come to a complete stop, yield to vehicles that arrived before you, and proceed only when it's safe. If you arrive at the same time as another vehicle, yield to the vehicle on your right. This rule applies even on major roads where you normally wouldn't expect to stop.",
    difficulty: "intermediate",
    context: "urban",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the N3 at Van Reenen's Pass between Gauteng and KZN when you encounter patches of dense fog reducing visibility to less than 50 meters. There's heavy truck traffic on this route.",
    question: "What is the safest approach to driving in these conditions?",
    options: ["Maintain highway speed but stay in the emergency lane", "Drive with hazard lights on at normal speed", "Reduce speed significantly, maintain extra distance from trucks, use appropriate lights", "Pull over at the nearest opportunity and wait for conditions to improve"],
    correct: 2,
  ...
  },
  {
    ...
    scenario: "You're driving on Airport Approach Road near Cape Town International during extremely strong Cape Doctor winds. Your vehicle is being buffeted by powerful gusts and you see dust and debris blowing across the road.",
    question: "How should you control your vehicle in these strong wind conditions?",
    options: ["Accelerate to drive through gusts more quickly", "Grip the steering wheel loosely to allow natural correction", "Reduce speed, grip the wheel firmly with both hands, and be prepared for directional changes", "Drive in the center of the road to avoid being blown off course"],
    correct: 2,
    explanation: "In strong wind conditions like Cape Town's notorious 'Cape Doctor' south-easter, reduce your speed significantly, grip the steering wheel firmly with both hands at the 9 and 3 o'clock positions, and be prepared to make steering corrections when hit by gusts. Be especially cautious when passing high-sided vehicles, crossing bridges, or moving from sheltered areas to exposed ones. Allow extra space around your vehicle, particularly from motorcycles and trucks which may be affected more severely by wind.",
    difficulty: "advanced",
    context: "urban",
    weather: "wind",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R103 in the KwaZulu-Natal Midlands early in the morning when you encounter patches of mist and ground fog in the valleys. Visibility fluctuates between clear and very limited.",
    question: "What is the appropriate way to handle these changing visibility conditions?",
    options: ["Maintain a constant speed regardless of visibility to avoid disrupting traffic flow", "Repeatedly turn headlights on and off to make yourself more visible", "Adjust speed according to visibility, using appropriate lights consistently throughout", "Pull over in each foggy patch and resume driving in clear sections"],
    correct: 2,
  ...
  },
  {
    ...
    scenario: "After heavy rain in Mpumalanga, you approach a low water bridge on the R536 near Hazyview with water flowing across the road surface. There are no depth indicators visible.",
    question: "What should you do at this flooded crossing?",
    options: ["Drive through slowly in first gear without stopping", "Test the depth by walking through the water first, then decide", "Do not attempt to cross; turn around and find an alternative route", "Wait to observe if other vehicles cross successfully, then follow their example"],
    correct: 2,
    explanation: "When encountering a flooded low water bridge with no visible depth indicators and water flowing across the road, you should not attempt to cross. Even seemingly shallow water can be powerful enough to sweep vehicles away, hide washouts in the road surface, or cause engine damage. The safest action is to turn around and find an alternative route. The South African Weather Service and disaster management agencies consistently advise: 'Turn around, don't drown' when facing water crossings during flood conditions.",
    difficulty: "intermediate",
    context: "rural",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "While driving on the N1 in the Karoo near Beaufort West, you see a large dust storm approaching from the side of the road. Visibility is rapidly decreasing as dust envelops the highway.",
    question: "What is the safest action to take when encountering a dust storm?",
    options: ["Speed up to get through the dust storm as quickly as possible", "Stop immediately where you are on the highway with hazard lights on", "Reduce speed, turn on lights, and pull completely off the roadway if possible", "Keep driving at normal speed but sound your horn periodically"],
    correct: 2,
    explanation: "When encountering a dust storm, reduce speed immediately, turn on your headlights (not hazard lights while moving), and if visibility becomes too poor to proceed safely, pull completely off the roadway (not just onto the shoulder if possible). Once stopped, turn off all lights, set the parking brake, keep seatbelts fastened, turn off the engine, and stay in the vehicle. Dust storms in the Karoo can reduce visibility to near zero and create dangerous multi-vehicle accidents if drivers remain on the roadway.",
    difficulty: "advanced",
    context: "rural",
    weather: "wind",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on a wet N2 near Port Elizabeth after a brief shower. The speed limit is 120 km/h, but the road surface is visibly wet and there's light traffic.",
    question: "How should you adjust your following distance in these wet conditions?",
    options: ["Maintain the standard 2-second following distance", "Increase to a 3-second following distance", "Double your following distance to at least 4 seconds", "Following distance doesn't need adjustment, just drive more alertly"],
    correct: 2,
    explanation: "On wet roads, stopping distances can increase by up to 50% or more compared to dry conditions. You should at least double your following distance from the standard 2 seconds to a minimum of 4 seconds. This provides crucial additional time and space to react and stop safely if the vehicle ahead brakes suddenly. The 'only a fool breaks the two-second rule' rhyme should be adjusted to 'only a fool breaks the four-second rule' in wet conditions.",
    difficulty: "intermediate",
    context: "rural",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the N1 near Touws River in the Western Cape when you see a temporary warning sign indicating 'Snow Ahead - Caution.' The temperature is near freezing.",
    question: "What precautions should you take after seeing this warning?",
    options: ["Continue at normal speed but be prepared to see snow", "Reduce speed, increase following distance, and watch for ice especially on bridges", "Turn around and avoid the area completely", "Stop and put on snow chains immediately regardless of road conditions"],
    correct: 1,
    explanation: "Snow warnings in South African mountain passes should be taken seriously. Reduce your speed significantly, increase your following distance, and be especially cautious on bridges and in shaded areas where ice may form even if the main road appears clear. Watch for changing road texture that might indicate black ice. Most South African vehicles are not equipped with winter tires, making standard safety margins inadequate for these rare but dangerous conditions.",
    difficulty: "advanced",
    context: "rural",
    weather: "snow",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R21 near Kempton Park during a severe Highveld electrical storm. There's intense lightning, heavy rain, and poor visibility. You're concerned about lightning striking your vehicle.",
    question: "What is the safest approach regarding lightning while in your vehicle?",
    options: ["Exit the vehicle and lie flat on the ground away from the car", "Pull over under trees for protection from lightning", "Stay inside the vehicle as it provides protection from lightning", "Open all windows to equalize electrical pressure inside and outside"],
    correct: 2,
    explanation: "During a lightning storm, your vehicle provides good protection through the principle of a 'Faraday cage' effect where the metal body conducts electricity around the cabin, not through it. You should stay inside the vehicle, keep windows fully closed, avoid touching metal components, and if possible, pull over safely away from trees or high objects until the worst of the storm passes. Don't exit the vehicle during an active lightning storm as this puts you at much greater risk.",
    difficulty: "intermediate",
    context: "urban",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the M4 coastal highway in Durban during extremely heavy tropical rainfall. Water is pooling on the road, your windshield wipers are at maximum speed, and visibility is poor.",
    question: "What is the appropriate speed adjustment for these severe conditions?",
    options: ["Reduce speed by approximately 10-20% below the limit", "Reduce speed by at least 50% of the posted limit", "Maintain the speed limit to avoid being rear-ended", "Pull over immediately regardless of location"],
    correct: 1,
    explanation: "In extremely heavy rainfall with poor visibility and water pooling on the road, you should reduce your speed by at least 50% of the posted limit. Durban's tropical downpours can create dangerous driving conditions very quickly. The standard advice of reducing speed by just 10-20% is inadequate for severe conditions. Only pull over if you can find a safe location completely off the roadway, otherwise proceed at a greatly reduced speed with headlights on (not hazard lights while moving).",
    difficulty: "intermediate",
    context: "urban",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "You're approaching the Van Stadens Bridge on the N2 near Port Elizabeth in your small sedan during very strong coastal winds. There are wind warning signs posted.",
    question: "How should you cross the bridge safely in high winds?",
    options: ["Increase speed to cross the bridge quickly and minimize wind exposure time", "Wait for a large truck and follow closely behind it using it as a wind block", "Reduce speed significantly, grip the steering wheel firmly, and maintain lane position", "Cross in neutral gear to prevent wind affecting engine performance"],
    correct: 2,
    explanation: "When crossing bridges in high winds, reduce your speed significantly, grip the steering wheel firmly with both hands, and focus on maintaining your lane position. Be prepared for sudden gusts as you move from protected to exposed areas at the start of the bridge. Leave extra space around your vehicle, particularly from high-sided vehicles like trucks which may be affected more severely by crosswinds. Small sedans are particularly vulnerable to being pushed by strong lateral winds on exposed bridges.",
    difficulty: "advanced",
    context: "rural",
    weather: "wind",
    language: "en"
  ...
  },
  {
    ...
    scenario: "You're driving on the N2 near Plettenberg Bay during strong Berg wind conditions. The air is hot and dusty, visibility is somewhat reduced, and there are occasional gusts affecting your vehicle stability.",
    question: "What additional hazards should you be prepared for during Berg wind conditions?",
    options: ["Increased chance of vehicle overheating only", "Higher risk of veld fires near the road and smoke hazards", "Lower risk of accidents as roads are drier", "No special hazards beyond normal windy conditions"],
    correct: 1,
    explanation: "Berg winds in the Southern Cape create hot, dry conditions that significantly increase fire danger. When driving during Berg wind conditions, be alert for veld fires near roadways, sudden smoke across the road reducing visibility, emergency vehicles, and evacuating residents. If you encounter smoke crossing the road, slow down significantly and be prepared to stop if visibility becomes too poor. Also watch for debris blown onto the road and maintain a firm grip on the steering wheel to counter unexpected gusts.",
    difficulty: "intermediate",
    context: "rural",
    weather: "wind",
    language: "en"
  },
  {
    ...
    scenario: "You're driving through Tradouw Pass between Barrydale and Swellendam in dense mountain fog with visibility under 30 meters. You need to use your vehicle's lights appropriately.",
    question: "Which lighting combination is most appropriate for these foggy conditions?",
    options: ["High beam headlights and hazard lights", "Low beam headlights only", "Low beam headlights and front fog lights if equipped", "High beam headlights only"],
    correct: 2,
    explanation: "In fog, the most appropriate lighting combination is low beam headlights and front fog lights (if equipped). High beams reflect off the fog particles back into your eyes, reducing rather than improving visibility. Hazard lights should only be used when stationary or moving extremely slowly in emergency situations, not for normal driving in fog. Rear fog lights (if equipped) should be used in very dense fog to make your vehicle more visible from behind.",
    difficulty: "intermediate",
    context: "rural",
    weather: "fog",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on the R40 near Hazyview during the rainy season when you hear a weather alert on the radio warning of flash flood conditions for the area you're traveling through.",
    question: "What is the most appropriate response to this flash flood warning?",
    options: ["Continue your journey but drive faster to get through the area quickly", "Pull over at the next town or service station and wait for updated information", "Ignore the warning unless you actually see flooding on the road", "Call emergency services to come escort you through the area"],
    correct: 1,
    explanation: "When you receive a flash flood warning for your current location, the safest response is to pull over at the next safe place (town, service station, or rest area - not the side of the road) and wait for updated information. Flash floods can develop rapidly, particularly in mountainous areas like Mpumalanga, making roads impassable or washed away with little warning. Check weather apps, call the local traffic authority, or listen to radio updates before deciding whether to continue your journey or seek alternate routes.",
    difficulty: "advanced",
    context: "rural",
    weather: "rain",
    language: "en"
  },
  {
    ...
    scenario: "You're driving on Oxford Road in Johannesburg during a daytime rainstorm. Visibility is reduced due to the heavy rain and spray from other vehicles.",
    question: "According to South African road regulations, should you use headlights in this situation?",
    options: ["No, headlights are only legally required after sunset", "Yes, low beam headlights are legally required in reduced visibility conditions", "No, but hazard lights should be used instead", "Only if visibility drops below 100 meters"],
    correct: 1,
    explanation: "According to South African road regulations (National Road Traffic Act), headlights are legally required not only at night but in any conditions of reduced visibility, including rain, fog, snow, or dust, regardless of the time of day. Low beam headlights should be used in daytime rain to make your vehicle more visible to others and to improve your vision. Hazard lights should only be used when stationary or in emergency situations, not for driving in rain.",
    difficulty: "basic",
    context: "urban",
    weather: "rain",
    timeOfDay: "afternoon",
  ...
  },
  {
    ...
    scenario: "You're driving in Durban during humid weather when your windscreen suddenly starts fogging up from the inside, reducing visibility. You need to clear it quickly while still driving.",
    question: "What is the most effective way to quickly clear a fogged interior windscreen while driving?",
    options: ["Open all windows fully regardless of outside weather", "Turn air conditioning on, set to hot air, and direct airflow to the windscreen", "Wipe the windscreen continuously with your hand while driving", "Use the windscreen wipers with washer fluid"],
    correct: 1,
    explanation: "To quickly clear a fogged interior windscreen while driving, turn on the air conditioning (which removes moisture from the air), set the temperature to hot, and direct airflow to the windscreen. This combination of dry, hot air will rapidly clear condensation from the inside of the glass. Opening windows slightly can help in some conditions but isn't as effective as the AC method. Windscreen wipers only clear the exterior surface. If possible, pull over safely first to clear the windscreen before continuing.",
    difficulty: "basic",
    context: "urban",
    weather: "clear",
    language: "en"
