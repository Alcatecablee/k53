  ...
  return {
    ...
    offers: [
      ...
      },
      {
        ...
        availability: "https://schema.org/InStock",
        description:
          "Unlimited scenarios, advanced analytics, premium materials",
...
export function generateEducationalEventSchema() {
  return {
    ...
    description:
      "Comprehensive online preparation for K53 learner's license examination",
...
export function generateCanonicalUrl(
  path: string,
  baseUrl: string = "https://superk53.co.za",
): string {
