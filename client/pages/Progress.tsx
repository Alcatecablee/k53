        ...
        <div className="max-w-6xl mx-auto space-y-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold">Level {userStats.level}</h2>
                ...
                <div className="text-right">
                  <div className="text-4xl font-bold mb-2">{userStats.averageScore}%</div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            {category.mastered} of {category.total} lessons completed
                          </p>
                        </div>
                      </div>
                      <div className="text-right">
                        <div className="font-bold text-gray-800">{category.progress}%</div>
          ...
          <Card className="duolingo-card bg-gradient-to-r from-purple-500 to-pink-500 text-white">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-2xl font-bold mb-2">Ready for More Practice?</h3>
              <p className="mb-6 opacity-90">
                Focus on {userStats.weakestCategory} to improve your overall score!
              </p>
