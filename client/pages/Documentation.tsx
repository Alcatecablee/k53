            ...
            <div className="space-y-6">
              <div className="bg-slate-100 border border-black p-6">
                ...
                <p className="text-slate-700 mb-4">
                  SuperK53 is the official digital K53 learner's license
                  preparation platform authorized by the Department of
                  Transport, Republic of South Africa. Our comprehensive system
                  provides everything you need to successfully pass your
                  learner's license examination.
                </p>
              ...
              <div className="border border-black p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    <div className="w-8 h-8 bg-slate-800 border border-black text-white flex items-center justify-center font-bold">
                      1
                    </div>
                    <div>
                      <h5 className="font-bold text-slate-800">Registration</h5>
                      <p className="text-slate-700">
                        Navigate to any practice section and click "Sign In" to
                        access the registration form. Provide your email,
                        password, full name, and location.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-700">
                        Check your email for a verification link. Click the link
                        to activate your account and gain access to all platform
                        features.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-700">
                        Set your location to receive scenario-based questions
                        tailored to your specific area and local driving
                        conditions.
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid gap-4">
                  <div className="bg-slate-100 border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm">
                      Quick 5-minute assessment covering all categories. Perfect
                  ...
                  <div className="bg-slate-100 border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm">
                      Complete 25-minute simulation matching Department of
                      Transport examination standards.
                    </p>
                  </div>
                  <div className="bg-slate-100 border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2 flex items-center">
                    ...
                    <p className="text-slate-700 text-sm">
                      Location-aware real-world driving scenarios (5 daily
                      scenarios free, unlimited with premium).
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="border border-black p-6">
                ...
                <div className="bg-slate-100 border border-black p-4 mb-4">
                  ...
                  <p className="text-slate-700">
                    You must pass ALL three categories to receive your learner's
                    license.
                  </p>
                </div>
                ...
                <div className="grid gap-4">
                  <div className="border border-black p-4">
                    ...
                    <p className="text-slate-700 mb-3">
                      Quick 12-question assessment covering all categories (5
                      minutes).
                    </p>
                    <div className="text-sm text-slate-600">
                      <strong>Format:</strong> 2 Vehicle Controls + 5 Road Signs
                      + 5 Traffic Rules
                    </div>
                  </div>
                  <div className="border border-black p-4">
                    ...
                    <p className="text-slate-700 mb-3">
                      Complete 64-question simulation matching official
                      standards (25 minutes).
                    </p>
                    <div className="text-sm text-slate-600">
                      <strong>Format:</strong> 8 Vehicle Controls + 28 Road
                      Signs + 28 Traffic Rules
                    </div>
                  </div>
                  <div className="border border-black p-4">
                    <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-sm text-slate-600">
                      <strong>Limit:</strong> 5 scenarios daily (free) •
                      Unlimited (premium)
                    </div>
                  </div>
                </div>
              ...
              <div className="border border-black p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-slate-100 border border-black p-4">
                    ...
                    <p className="text-slate-700">
                      Receive driving scenarios tailored to your specific city
                      and province, reflecting local road conditions and
                      regulations.
                    </p>
                  </div>
                  <div className="bg-slate-100 border border-black p-4">
                    ...
                    <p className="text-slate-700">
                      Find nearby DLTC testing centers with contact information,
                      operating hours, and current wait times.
                    </p>
                  </div>
                  <div className="bg-slate-100 border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2 flex items-center">
                    ...
                    <p className="text-slate-700">
                      Access location-specific testing requirements, local
                      traffic patterns, and regional driving regulations.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="border border-black p-4">
                    ...
                    <ul className="text-sm text-slate-700 space-y-2">
                      ...
                      <li className="flex items-center">
                        <CheckCircle className="h-4 w-4 text-green-600 mr-2" />
                        Unlimited official tests
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="h-4 w-4 text-green-600 mr-2" />5
                        scenarios daily
                      </li>
                      <li className="flex items-center">
                        <CheckCircle className="h-4 w-4 text-green-600 mr-2" />
                ...
                <div className="space-y-4">
                  <div className="border border-black p-4">
                    ...
                    <p className="text-slate-700 mb-2">
                      R49 per month - Cancel anytime
                    </p>
                    <div className="text-sm text-slate-600">
                      Automatic renewal, cancel anytime through your profile.
                    </div>
                  </div>
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
                    ...
                    <p className="text-slate-700 mb-2">
                      One-time purchases for additional scenarios
                    </p>
                    <div className="text-sm text-slate-600">
                      • 50 Scenarios: R19
                      <br />
                  ...
                  <div className="bg-slate-100 border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm">
                      All payments processed securely through PayPal with
              ...
              <div className="border border-black p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-orange-50 border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm">
                      If experiencing connectivity issues, the platform will
                      automatically switch to offline mode with basic
                      functionality.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <div className="border border-black p-6">
                ...
                <div className="space-y-4">
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
                      Is SuperK53 officially recognized?
                    </h5>
                    <p className="text-slate-700 text-sm">
                      Yes, SuperK53 is certified by the Department of Transport
                      and aligned with current K53 regulations and testing
                      standards.
                    </p>
                  </div>
                  <div className="border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm">
                      Our tests are based on official K53 curriculum and updated
                      regularly to match current examination standards. The
                      question format and difficulty match the actual test.
                    </p>
                  </div>
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
                  ...
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
                      How many times can I take practice tests?
                    </h5>
                    <p className="text-slate-700 text-sm">
                      Unlimited! You can take as many practice and official
                      simulation tests as you want. Only scenario tests have a
                      daily limit (5 free, unlimited with premium).
                    </p>
                  </div>
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
                    ...
                    <p className="text-slate-700 text-sm">
                      An account is required to access tests and track progress.
                      Registration is free and includes email verification for
                      security.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              <div className="border border-black p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
                      Tests not saving progress?
                    </h5>
                    <p className="text-slate-700 text-sm">
                      Ensure you're logged in and have a stable internet
                      connection. Progress is automatically saved to your
                      account upon test completion.
                    </p>
                  </div>
                  <div className="border border-black p-4">
                    <h5 className="font-bold text-slate-800 mb-2">
              ...
              <div className="border border-black p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="border border-black p-4">
                    ...
                    <div className="text-slate-700 space-y-2">
                      <p>
                        <strong>General:</strong> support@superk53.co.za
                      </p>
                      <p>
                        <strong>Technical:</strong> tech@superk53.co.za
                      </p>
                      <p>
                        <strong>Billing:</strong> billing@superk53.co.za
                      </p>
              ...
              <div className="border border-black p-6">
                ...
                <div className="space-y-4">
                  <div className="border border-black p-4">
                    ...
                    <div className="text-slate-700 text-sm">
                      <p>
                        <strong>Email:</strong> feedback@superk53.co.za
                      </p>
                      <p>
                        <strong>Subject:</strong> Include "Platform Feedback" in
                        subject line
                      </p>
                    </div>
                  </div>
                  <div className="border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm mb-3">
                      Help us maintain accuracy by reporting any errors in
                      questions or answers.
                    </p>
                    <div className="text-slate-700 text-sm">
                      <p>
                        <strong>Email:</strong> questions@superk53.co.za
                      </p>
                      <p>
                        <strong>Include:</strong> Question ID, category, and
                  ...
                  <div className="bg-slate-100 border border-black p-4">
                    ...
                    <p className="text-slate-700 text-sm">
                      Suggest new features or improvements that would enhance
